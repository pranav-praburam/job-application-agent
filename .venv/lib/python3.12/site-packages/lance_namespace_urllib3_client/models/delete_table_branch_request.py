...
class DeleteTableBranchRequest(BaseModel):
    """
    ...
    name: StrictStr = Field(description="Name of the branch to delete")
    __properties: ClassVar[List[str]] = ["identity", "context", "id", "name"]
