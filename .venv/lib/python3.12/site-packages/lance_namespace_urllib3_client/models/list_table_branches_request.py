...
class ListTableBranchesRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["identity", "context", "id", "page_token", "limit"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListTableBranchesRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListTableBranchesRequest from a dict"""
        if obj is None:
            return None
