...
class ListTableBranchesResponse(BaseModel):
    """
    Response containing table branches
    """ # noqa: E501
    branches: Dict[str, BranchContents] = Field(description="Map of branch names to their contents")
    ...
    __properties: ClassVar[List[str]] = ["branches", "page_token"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "branches": dict(
                (_k, BranchContents.from_dict(_v))
