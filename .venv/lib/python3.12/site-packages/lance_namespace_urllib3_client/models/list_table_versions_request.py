...
class ListTableVersionsRequest(BaseModel):
    ...
    descending: Optional[StrictBool] = Field(default=None, description="When true, versions are guaranteed to be returned in descending order (latest to oldest). When false or not specified, the ordering is implementation-defined. ")
    __properties: ClassVar[List[str]] = ["identity", "context", "id", "branch", "page_token", "limit", "descending"]
