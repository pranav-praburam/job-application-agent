...
class UpdateTableSchemaMetadataRequest(BaseModel):
    """
    ...
    metadata: Optional[Dict[str, StrictStr]] = Field(default=None, description="Schema metadata key-value pairs to set")
    __properties: ClassVar[List[str]] = ["identity", "context", "id", "branch", "metadata"]
